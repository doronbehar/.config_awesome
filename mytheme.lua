...
-- {{{1 Directories
copycats_themes_dir                             = os.getenv("HOME") .. "/.config/awesome/themes@copycats"
system_awesome_dir                              = "/usr/share/awesome"
system_themes_dir                               = system_awesome_dir .. "themes"
serialoverflow_themes_dir                       = os.getenv("HOME") .. "/.config/awesome/themes@serialoverflow"
mywallpapers                                    = os.getenv("HOME") .. "/.config/awesome/wallpapers"
